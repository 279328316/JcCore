...
namespace Jc.Core.Util
{
    public enum SpellFormates
    {
        Default=0,
        ToUpper=1,
        ToLower=2,
    ...
    /// </summary>
    public static class ChineseToSpellHelper
   {
       #region 属性数据定义
       /// <summary>
        /// 汉字的机内码数组
        ...
        /// <param name="hzString">汉字字符串</param>
        /// <returns>转换后的拼音(全拼)字符串</returns>
        public static string ConvertWithSplitChar(string hzString, string splitChar, SpellFormates formate=SpellFormates.Default)
        {
            // 匹配中文字符
            Regex regex = new Regex("^[\u4e00-\u9fa5]$");
            byte[] array = new byte[2];
