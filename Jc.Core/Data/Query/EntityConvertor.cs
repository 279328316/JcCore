...
namespace Jc.Core.Data.Query
{
    ...
    public class EntityConvertor
    {
        ...
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public static EntityConvertorDelegate CreateEntityConvertor<T>(DtoMapping dtoMapping)
        {
            DynamicMethod dynamicMethod = BuildSetValueMethod<T>(dtoMapping);
        ...
        public static DynamicMethod BuildSetValueMethod<T>(DtoMapping dtoMapping)
        {
        ...
        /// <typeparam name="T">返回的实体类型</typeparam>
        /// <returns>实体对象</returns>
        public static IEntityConvertor BuildSetValueMethodNew<T>()
        {
            ...
            ModuleBuilder moduleBuilder = assemblyBuilder.DefineDynamicModule("ConvertModule");
            TypeBuilder typeBuilder = moduleBuilder.DefineType("DtoConvert", TypeAttributes.Public);
            ...
            il.Emit(OpCodes.Ret);
            var type1 = typeBuilder.CreateTypeInfo();
